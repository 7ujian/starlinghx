...
class BitmapChar
{
	...
	{
		if (mKernings == null || mKernings.exists(charID)) return 0.0;
	...
	public var charID(get_charID, null):Int;
	...
	public var xOffset(get_xOffset, null):Float;
	...
	public var yOffset(get_yOffset, null):Float;
	...
	public var xAdvance(get_xAdvance, null):Float;
