 ...
 *  </p> */
@:allow(starling.text) class MiniBitmapFont
{
...
//	];
	...
	private static inline var XML_STRING = '<font>
	...
	public static var texture(get_texture, null):Texture;
