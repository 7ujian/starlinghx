...
//            }
	...
	public var hasVisibleArea(get_hasVisibleArea, null):Bool;
	...
	public override function addEventListener(type:String, listener:Dynamic->Void):Void
	{
	...
	public override function removeEventListener(type:String, listener:Dynamic->Void):Void
	{
	...
	private function addEnterFrameListenerToStage(event:Event=null):Void
	{
		Starling.current.stage.addEnterFrameListener(this);
	}

	private function removeEnterFrameListenerFromStage(event:Event=null):Void
	{
	...
	private inline function get_width():Float { return getBounds(mParent, sHelperRect).width; }
	...
	private inline function get_height():Float { return getBounds(mParent, sHelperRect).height; }
	...
	private inline function get_scaleX():Float { return mScaleX; }
	...
	private inline function get_scaleY():Float { return mScaleY; }
	...
	private inline function get_touchable():Bool { return mTouchable; }
	 ...
	 *  performance reasons). */
	public var filter(get_filter, set_filter):FragmentFilter;
	private inline function get_filter():FragmentFilter { return mFilter; }
	...
	private inline function get_parent():DisplayObjectContainer { return mParent; }

	/** The topmost object in the display tree the object is part of. */
	public var base(get_base, null):DisplayObject;
	...
	private function get_stage():Stage { return StdExt.dynamicCast(base, Stage); }
}
