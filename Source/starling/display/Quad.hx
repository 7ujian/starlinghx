...
class Quad extends DisplayObject
{
	...
	public inline function getVertexColor(vertexID:Int):UInt
	{
	...
	public inline function getVertexAlpha(vertexID:Int):Float
	{
	...
	private inline function get_tinted():Bool { return mTinted; }
	...
	private inline function get_premultipliedAlpha():Bool { return mVertexData.premultipliedAlpha; }
}
