...
class FragmentFilter
{
	...
	private static inline var MIN_TEXTURE_SIZE:Int = 64;
	...
	private static inline var STD_VERTEX_SHADER:String = 
		"m44 op, va0, vc0 \n" + // 4x4 matrix transform to output space
		"mov v0, va1      \n";  // pass texture coordinates to fragment program
	
	/** The standard fragment shader code. It just forwards the texture color to the output. */
	private static inline var STD_FRAGMENT_SHADER:String =
	...
	{
#if debug
		if (Type.getClassName(Type.getClass(this)) == "starling.filters::FragmentFilter")
		{
...
//		mIndexData.fixed = true;
									 ...
									 resultPotRect:Rectangle):Void
	{
		...
		{    
			...
			resultPotRect.setTo(
				...
				GetNextPowerOfTwo.getNextPowerOfTwo(Std.int(minWidth  * scale)) / scale,
				GetNextPowerOfTwo.getNextPowerOfTwo(Std.int(minHeight * scale)) / scale);
		}
	}
	...
	private function assembleAgal(fragmentShader:String=null, vertexShader:String=null):GLSLProgram
	{
	...
	/** @private */
	@:allow(starling) function compile(object:DisplayObject):QuadBatch
	{
	...
	public var marginX(get_marginX, set_marginX):Float;
	 ...
	 *  Useful when the filter will "grow" the rendered object. */
	public var marginY(get_marginY, set_marginY):Float;
	...
	public var numPasses(get_numPasses, set_numPasses):Int;
	...
	public var vertexPosAtID(get_vertexPosAtID, set_vertexPosAtID):Int;
	...
	public var texCoordsAtID(get_texCoordsAtID, set_texCoordsAtID):Int;
	...
	public var baseTextureID(get_baseTextureID, set_baseTextureID):Int;
	...
	public var mvpConstantID(get_mvpConstantID, set_mvpConstantID):Int;
