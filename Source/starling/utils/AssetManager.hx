...
class AssetManager extends EventDispatcher
{
	...
	private var mTextures:StringMap<Texture>;
	private var mAtlases:StringMap<TextureAtlas>;
	...
	private function processRawAsset(name:String, rawAsset:Dynamic, xmls:Vector<XML>,
	 ...
	 *  used. */
	public function get useMipMaps():Bool { return mUseMipMaps; }
	public function set useMipMaps(value:Bool):Void { mUseMipMaps = value; }

	/** Textures that are created from Bitmaps or ATF files will have the scale factor
	 *  assigned here. */
	public function get scaleFactor():Float { return mScaleFactor; }
	public function set scaleFactor(value:Float):Void { mScaleFactor = value; }
