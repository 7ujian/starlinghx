...
class TouchEvent extends Event
{
	...
	@:allow(starling.events) function dispatch(chain:Vector<EventDispatcher>):Void
	{
	...
	public var touches(get_touches, null):Vector<Touch>;
	// TODO removed .concat()
	private function get_touches():Vector<Touch> {
		var ret:Vector<Touch> = cast data;
		return ret.concat();
	}
